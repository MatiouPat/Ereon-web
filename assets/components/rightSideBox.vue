<template>
    <ul class="right-side-box-actions">
        ...
        <li title="Personages" @click="choose(1)">
            <svg height="24px" viewBox="0 0 24 24" width="24px" :fill="pageIndex == 1 ? '#D68836' : '#565656'"><g><rect fill="none" height="24" width="24"/></g><g><path d="M21,3H3v18h18V3z M12,6c1.93,0,3.5,1.57,3.5,3.5c0,1.93-1.57,3.5-3.5,3.5s-3.5-1.57-3.5-3.5C8.5,7.57,10.07,6,12,6z M19,19 H5v-0.23c0-0.62,0.28-1.2,0.76-1.58C7.47,15.82,9.64,15,12,15s4.53,0.82,6.24,2.19c0.48,0.38,0.76,0.97,0.76,1.58V19z"/></g></svg>
        </li>
        <li title="Jukebox" v-if="isGameMaster" @click="choose(2)">
            <svg height="24px" viewBox="0 0 24 24" width="24px" :fill="pageIndex == 2 ? '#D68836' : '#565656'"><path d="M0 0h22v22H0V0z" style="fill:none"/><path d="M20.17 1.83H1.83v18.33h18.33V1.83zm-4.58 5.73h-3.44v6.3A2.86 2.86 0 1 1 9.29 11c.65 0 1.24.22 1.72.58V5.27h4.58v2.29z"/></svg>
        </li>
